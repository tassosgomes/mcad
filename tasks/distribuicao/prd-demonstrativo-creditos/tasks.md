...
- [x] 7.0 Frontend — componentes React + integracao em ProcessoDetailPage
- [x] 8.0 Testes unitarios dos handlers e repositorio
- [x] 9.0 Testes de integracao (DemonstrativoControllerIntegrationTest)
