...
const authorizedRouteByPermission: Array<{ permission: string; path: string }> = [
  ...
  { permission: 'arrecadacao:default:cliente:listar', path: '/arrecadacao/usuarios-musica' },
  { permission: 'arrecadacao:default:contrato:listar', path: '/arrecadacao/licencas' },
  { permission: 'arrecadacao:default:pagamento:listar', path: '/arrecadacao/pagamentos' },
  { permission: 'arrecadacao:default:relatorio:visualizar', path: '/arrecadacao/verbas' },
  { permission: 'arrecadacao:default:cobranca:listar', path: '/arrecadacao/uda' },
