...
const navigation: SidebarGroup[] = [
  ...
  },
  {
    ...
    children: [
      { label: 'Usuários de Música', path: '/arrecadacao/usuarios-musica', requiredPermission: 'arrecadacao:default:cliente:listar' },
      { label: 'Licenças', path: '/arrecadacao/licencas', requiredPermission: 'arrecadacao:default:contrato:listar' },
      { label: 'Pagamentos', path: '/arrecadacao/pagamentos', requiredPermission: 'arrecadacao:default:pagamento:listar' },
      { label: 'Verbas', path: '/arrecadacao/verbas', requiredPermission: 'arrecadacao:default:relatorio:visualizar' },
      { label: 'UDA', path: '/arrecadacao/uda', requiredPermission: 'arrecadacao:default:cobranca:listar' },
