...
produces: ["tasks/prd-[slug]/api-contract.yaml", "tasks/prd-[slug]/api-contract.md"]
---
...
6. **Próximos passos:**
   - Backend: "Use a skill `flow-techspec-creator` referenciando este contrato como input adicional"
   - Frontend: "Use a skill `flow-techspec-creator` referenciando este contrato — os schemas são a fonte de verdade para os tipos"
