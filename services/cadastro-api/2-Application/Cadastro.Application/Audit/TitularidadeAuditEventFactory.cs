...
public sealed class TitularidadeAuditEventFactory
{
    ...
    private const string EntityType = "TitularidadeAutoral";
    private const string ScreenId = "CADASTRO_OBRAS";
    private const string ScreenName = "Obras";

    public AuditEvent UserAction(TitularidadeAutoral t, AuditContext context, TitularidadeAuditOperation operation) =>
        new(
            ...
            Data: null,
            Security(),
            Metadata: new Dictionary<string, object?> { ["reason"] = operation.Reason, ["obraId"] = t.ObraId.ToString() },
            Screen: null,
    ...
    public AuditEvent DataChange(
        TitularidadeAutoral t,
        AuditContext context,
        TitularidadeAuditOperation operation,
        IReadOnlyDictionary<string, object?>? before)
    {
        var after = operation.DataAction == DataAction.DELETE ? null : Map(t);
    ...
    public IReadOnlyDictionary<string, object?> Map(TitularidadeAutoral t) =>
        new Dictionary<string, object?>
        {
            ["id"] = t.Id.ToString(),
            ["obraId"] = t.ObraId.ToString(),
            ["titularId"] = t.TitularId.ToString(),
            ["categoria"] = t.Categoria.ToString().ToUpperInvariant(),
    ...
    private static Dictionary<string, object?> BusinessContext(TitularidadeAutoral t) =>
        new() { ["entityType"] = EntityType, ["entityId"] = t.Id.ToString(), ["obraId"] = t.ObraId.ToString() };
