...
namespace Cadastro.Infra.Data.Migrations
{
    ...
    [Migration("20260507170000_AddAuditOutbox")]
    public partial class AddAuditOutbox : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                CREATE TABLE IF NOT EXISTS cadastro.audit_outbox (
            ...
            migrationBuilder.Sql("""
                CREATE INDEX IF NOT EXISTS ix_audit_outbox_pending
                    ON cadastro.audit_outbox(status, available_at_utc, created_at_utc);
                """);

            migrationBuilder.Sql("""
                CREATE INDEX IF NOT EXISTS ix_audit_outbox_event_type
                    ON cadastro.audit_outbox(event_type, created_at_utc);
                """);
        }
