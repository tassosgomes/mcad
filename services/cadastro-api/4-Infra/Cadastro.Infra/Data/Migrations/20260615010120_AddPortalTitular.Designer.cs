...
namespace Cadastro.Infra.Data.Migrations
{
    ...
    [Migration("20260615010120_AddPortalTitular")]
    partial class AddPortalTitular
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cadastro.Domain.Entities.Anexo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("UploadadoPor")
                        .IsRequired()
                        .HasColumnType("VARCHAR(200)");

                    b.HasKey("Id");

                    b.HasIndex("StatusScan")
                        .HasDatabaseName("ix_anexos_status_scan_ativo")
                        .HasFilter("\"ExcluidoEm\" IS NULL");

                    b.HasIndex("EntidadeId", "Categoria")
                        .IsUnique()
            ...
            modelBuilder.Entity("Cadastro.Domain.Entities.CredencialTitular", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("credenciais_titular", "cadastro");
                });
            ...
            modelBuilder.Entity("Cadastro.Domain.Entities.Ocorrencia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TitularId", "Status")
                        .HasDatabaseName("ix_ocorrencias_titular_status");

                    b.ToTable("ocorrencias", "cadastro", t =>
                        {
                            t.HasCheckConstraint("ck_ocorrencias_status", "\"Status\" IN ('ABERTA','EM_ANALISE','RESOLVIDA','CANCELADA')");

                            t.HasCheckConstraint("ck_ocorrencias_tipo", "\"Tipo\" IN ('TITULARIDADE_DIVERGENTE','FONOGRAMA_INCORRETO','DADO_CADASTRAL','OBRA_AUSENTE')");
                        });
                });
            ...
            modelBuilder.Entity("Cadastro.Domain.Entities.SolicitacaoAlteracao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ValorPretendido")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("solicitacoes_alteracao", "cadastro", t =>
                        {
                            t.HasCheckConstraint("ck_solicitacoes_alteracao_campo", "\"Campo\" IN ('NOME','CAE_IPI','ASSOCIACAO','CATEGORIA')");

                            t.HasCheckConstraint("ck_solicitacoes_alteracao_status", "\"Status\" IN ('SOLICITADA','APROVADA','REJEITADA')");
                        });
                });
            ...
            modelBuilder.Entity("Cadastro.Domain.Entities.CredencialTitular", b =>
                {
                    b.HasOne("Cadastro.Domain.Entities.Titular", null)
                        .WithOne()
                        .HasForeignKey("Cadastro.Domain.Entities.CredencialTitular", "TitularId")
            ...
            modelBuilder.Entity("Cadastro.Domain.Entities.Titular", b =>
                {
                    ...
                    b.OwnsOne("Cadastro.Domain.ValueObjects.Endereco", "Endereco", b1 =>
                        {
                            b1.Property<Guid>("TitularId")
                                .HasColumnType("uuid");
                            ...
                            b1.ToTable("titulares", "cadastro");

                            b1.WithOwner()
                                .HasForeignKey("TitularId");
                        });

                    b.OwnsMany("Cadastro.Domain.ValueObjects.TelefoneTitular", "Telefones", b1 =>
                        {
                            b1.Property<Guid>("TitularId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("TitularId", "Ordem");

                            b1.HasIndex("TitularId")
                                .HasDatabaseName("ix_telefones_titular_titular");

                            b1.ToTable("telefones_titular", "cadastro");
