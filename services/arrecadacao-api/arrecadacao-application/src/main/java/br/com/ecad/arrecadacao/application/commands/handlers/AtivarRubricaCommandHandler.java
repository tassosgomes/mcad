...
@Component
public class AtivarRubricaCommandHandler implements CommandHandler<AtivarRubricaCommand, RubricaResponse> {

    private final RubricaRepository repository;
    private final OutboxEventWriter outboxEventWriter;

    public AtivarRubricaCommandHandler(RubricaRepository repository,
