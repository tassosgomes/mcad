CREATE TABLE IF NOT EXISTS arrecadacao.usuarios_identidade (
...
CREATE INDEX IF NOT EXISTS ix_usuarios_identidade_username
    ON arrecadacao.usuarios_identidade(username)
    WHERE username IS NOT NULL;

CREATE INDEX IF NOT EXISTS ix_usuarios_identidade_email
    ON arrecadacao.usuarios_identidade(email)
    WHERE email IS NOT NULL;

CREATE INDEX IF NOT EXISTS ix_usuarios_identidade_status
    ON arrecadacao.usuarios_identidade(is_suspended, deleted_at_utc);
