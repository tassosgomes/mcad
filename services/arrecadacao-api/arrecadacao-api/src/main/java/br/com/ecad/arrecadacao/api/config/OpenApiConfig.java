...
/**
 * Metadados da documentacao OpenAPI (springdoc) do servico de Arrecadacao.
 *
...
public class OpenApiConfig {
    ...
    @Bean
    OpenAPI arrecadacaoOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                .title("Arrecadacao API")
                .version("v1")
                .description("API REST do dominio de Arrecadacao — rubricas, licencas, "
                    + "pagamentos, estornos e verba liquida."))
