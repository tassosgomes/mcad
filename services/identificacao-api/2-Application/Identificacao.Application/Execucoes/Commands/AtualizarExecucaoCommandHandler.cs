...
public class AtualizarExecucaoCommandHandler : ICommandHandler<AtualizarExecucaoCommand, ExecucaoResponse>
{
    ...
    public async Task<ExecucaoResponse> HandleAsync(AtualizarExecucaoCommand command, CancellationToken ct)
    {
        ...
        if (captacao.Status != StatusCaptacao.Aberta)
            throw new DomainException("Apenas captações ABERTAS podem ter suas execuções editadas.");
        ...
        return new ExecucaoResponse(
            ...
            execucao.Quantidade,
            tipoUtilizacao != null ? new TipoUtilizacaoResponse(tipoUtilizacao.Id, tipoUtilizacao.Sigla, tipoUtilizacao.Descricao, tipoUtilizacao.Peso) : 
                (execucao.TipoUtilizacao != null ? new TipoUtilizacaoResponse(execucao.TipoUtilizacao.Id, execucao.TipoUtilizacao.Sigla, execucao.TipoUtilizacao.Descricao, execucao.TipoUtilizacao.Peso) : null),
